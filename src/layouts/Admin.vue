        ...
        <div class="row" style="height:100vh;">
          <div class="col-12 col-xl-2 sidebar border-right text-center py-4 raised">
            ...
            <ul class="nav flex-column mt-4 text-left d-none d-xl-block">
              ...
              <li class="nav-item">
                <a class="nav-link opacity-50" href="#">
                  <i class="fa fa-fw fa-caret-left mr-3 text-dark-blue opacity-30"></i>Back to site.
                </a>
              </li>
            </ul>
          </div>
          <div class="col-12 col-xl-10 px-0 mx-0">
            <main class="main px-0 pt-0">
              <slot />
            </main>
          </div>
        </div>
...
.sidebar {
  ...
  border-right: 1px solid rgba(0, 79, 160, 0.175) !important;
  border-bottom: 1px solid rgba(0, 79, 160, 0.15) !important;
}
</style>