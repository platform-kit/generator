...
class Product {
    ...
    getContent() {
        ...
        var workingContentPath = path.resolve(__dirname + './../../data/content/content-jfsKbye9C.md'); // this path works in another function.
        console.log(workingContentPath);
        console.log(fs.readFileSync(workingContentPath, 'utf8'));
