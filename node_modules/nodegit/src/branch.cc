  ...
  void GitBranch::InitializeComponent(v8::Local<v8::Object> target) {
    Nan::HandleScope scope;
       ...
       v8::Local<Object> object = Nan::New<Object>();
         ...
         Nan::SetMethod(object, "upstreamName", UpstreamName);
         Nan::SetMethod(object, "upstreamRemote", UpstreamRemote);
...
// end convert_from_v8 block
  ...
  CreateFromAnnotatedWorker *worker = new CreateFromAnnotatedWorker(baton, callback);
        ...
        if (!info[0]->IsUndefined() && !info[0]->IsNull())
          worker->SaveToPersistent("repository", Nan::To<v8::Object>(info[0]).ToLocalChecked());
        if (!info[1]->IsUndefined() && !info[1]->IsNull())
          worker->SaveToPersistent("branch_name", Nan::To<v8::Object>(info[1]).ToLocalChecked());
        if (!info[2]->IsUndefined() && !info[2]->IsNull())
          worker->SaveToPersistent("commit", Nan::To<v8::Object>(info[2]).ToLocalChecked());
        if (!info[3]->IsUndefined() && !info[3]->IsNull())
          worker->SaveToPersistent("force", Nan::To<v8::Object>(info[3]).ToLocalChecked());
...
// end convert_from_v8 block
  ...
  LookupWorker *worker = new LookupWorker(baton, callback);
        ...
        if (!info[1]->IsUndefined() && !info[1]->IsNull())
          worker->SaveToPersistent("branch_name", Nan::To<v8::Object>(info[1]).ToLocalChecked());
        if (!info[2]->IsUndefined() && !info[2]->IsNull())
          worker->SaveToPersistent("branch_type", Nan::To<v8::Object>(info[2]).ToLocalChecked());
...
// end convert_from_v8 block
  ...
  MoveWorker *worker = new MoveWorker(baton, callback);
        ...
        if (!info[0]->IsUndefined() && !info[0]->IsNull())
          worker->SaveToPersistent("branch", Nan::To<v8::Object>(info[0]).ToLocalChecked());
        if (!info[1]->IsUndefined() && !info[1]->IsNull())
          worker->SaveToPersistent("new_branch_name", Nan::To<v8::Object>(info[1]).ToLocalChecked());
        if (!info[2]->IsUndefined() && !info[2]->IsNull())
...
// end convert_from_v8 block
  ...
  NameWorker *worker = new NameWorker(baton, callback);
        ...
        if (!info[0]->IsUndefined() && !info[0]->IsNull())
          worker->SaveToPersistent("ref", Nan::To<v8::Object>(info[0]).ToLocalChecked());
...
// start convert_to_v8 block
  if (baton->out){
       to = Nan::New<v8::String>(baton->out).ToLocalChecked();
   }
  else {
    to = Nan::Null();
  }
...
// end convert_from_v8 block
  ...
  RemoteNameWorker *worker = new RemoteNameWorker(baton, callback);
        ...
        if (!info[0]->IsUndefined() && !info[0]->IsNull())
          worker->SaveToPersistent("repo", Nan::To<v8::Object>(info[0]).ToLocalChecked());
        if (!info[1]->IsUndefined() && !info[1]->IsNull())
          worker->SaveToPersistent("refname", Nan::To<v8::Object>(info[1]).ToLocalChecked());
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[2]));
  UpstreamNameWorker *worker = new UpstreamNameWorker(baton, callback);
